...
cognito_settings = Settings(
    ...
    COGNITO_USERPOOL_ID=Setting(path='/auth/cognito/user_pool_id', default='defaultpool', type_=str),
    COGNITO_APP_CLIENT_ID=Setting(path='/auth/cognito/client_id', default='defaultid', type_=str),
    ...
    COGNITO_DOMAIN=Setting(path='/auth/cognito/domain', default='defaultdomain', type_=str),
